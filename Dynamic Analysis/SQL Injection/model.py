...
your_command = ['docker', 'exec', 'sysdig', 'sysdig', '-p', '"%evt.time %evt.type"', 'container.id=142631c77c84']
# your_command = ['docker', 'exec', 'sysdig', 'sysdig', '-p', '"%evt.time %evt.type"', 'container.name=vulnerablewebappwsgi_mysql_1']
